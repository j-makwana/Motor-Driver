...
// TIMER_FLAG_ASYNC determines if the timer is async (ticks from ISR) or sync (manual update)
// In your example, since TIMER_FLAG_ASYNC is not set, the timer is sync and scheduled for 1 ms intervals
